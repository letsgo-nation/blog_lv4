package com.example.springblog.jwt;

import java.io.IOException;

import com.example.springblog.dto.ApiResponseDto;
import com.example.springblog.security.UserDetailsServiceImpl;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if(token != null) {
            if(!jwtUtil.validateToken(token)){
                ...
                // response.getWriter().write(objectMapper.writeValueAsString(responseDto)); : 자바 객체를 제이슨 형태로 바꿔준다.
                return;
            }
